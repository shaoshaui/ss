...
const siteData = [
  {
    ...
    items: [
      ...
      {
        icon: "https://www.chaonengso.com/favicon.ico",
        name: "网盘资源搜索",
        desc: "超能搜搜索引擎收录了数十款百度网盘搜索引擎，最干净、最好用的资源搜索引擎。",
        link: "https://lingdaima.com/"
      },
      {
        icon: "https://www.virustotal.com/gui/images/manifest/icon-48x48.png",
        name: "virustotal",
        desc: "病毒文件查杀",
      ...
      {
        icon: "https://it-tools.tech/android-chrome-192x192.png",
        name: "it-tools",
        desc: "开发工具箱",
        link: "https://it-tools.tech/xml-formatter"
      },
      {
        icon: "https://he3app.com/section/logo.png",
        name: "he3app",
        desc: "He3 是一款开发者工具箱，有500+ 以上工具并且在持续增长。",
        link: "https://he3app.com/zh/"
      },
      {
        icon: "",
        name: "Jpg-C",
        desc: "Jpg-C 图像批量修整压缩剪裁调整大小工具",
        link: "http://zzy.my/blog/post/Jpg-C"
      }
    ]
  },
  {
    ...
    items: [
      ...
      {
        icon: "https://avatars.githubusercontent.com/u/20920490?v=4",
        name: "github上最有名的AI绘画项目",
        desc: "可以通过此项目本地部署，使用电脑GPU生产图片，限制取决于你电脑内存和显存容量",
        link: "https://github.com/AUTOMATIC1111/stable-diffusion-webui"
      },
      {
        icon: "",
        name: "将 CG 角色制作成动画",
        desc: "一款 AI 工具，可自动将 CG 角色制作成动画、灯光并组合成真人场景",
    ...
    items: [
      {
        ...
        name: "前端日常笔记",
        desc: "日常笔记记录",
        link: "https://github.com/taozuidesongshu"
      },
      {
        icon: "",
        name: "前端思维导图",
      ...
      },
      {
        ...
        name: "vitepress",
        desc: "vitepress博客文档",
        link: "https://vitepress.qzxdp.cn/reference/site-config.html"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        link: "https://www.runoob.com/jquery/jquery-tutorial.html"
      },
      {
        icon: "https://www.lodashjs.com/img/favicon.ico",
        name: "Lodash",
        desc: "Lodash 是一个具有一致接口、模块化、高性能等特性的 JavaScript 工具库",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "excalidraw",
        desc: "web画板工具",
        link: "https://juejin.cn/post/7232947178691444794?utm_source=gold_browser_extension"
      },
      {
        icon: "",
        name: "explorer",
        desc: "被墙检测",
        link: "https://explorer.ooni.org/zh-cn"
      },
      {
        icon: "",
        name: "aomao",
        desc: "富文本编辑器",
        link: "https://editor.aomao.com/zh-CN"
      },
      {
        icon: "",
        name: "wangeditor",
        desc: "wangeditor富文本编辑器",
  ...
  },
  {
    ...
    items: [
      {
        icon: "https://static.leetcode.cn/cn-legacy-assets/images/LeetCode_Sharing.png",
        name: "LeetCode",
        desc: "海量题库和技术面试资源",
